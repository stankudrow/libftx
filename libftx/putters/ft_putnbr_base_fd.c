...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/06 07:09:45 by stanislav         #+#    #+#             */
/*   Updated: 2022/01/06 07:09:46 by stanislav        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_putnbr_nbase_fd(int fd, int nbr, const char *bset, size_t bnum)
{
	if (nbr < 0)
	{
		ft_putchar_fd(fd, '-');
