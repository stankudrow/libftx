...
ctype_h := $(INC_D)/ft_ctype.h

gnl_d := $(SRC_D)/gnl
gnl_c := gnl.c gnl_utils.c
gnl_c := $(addprefix $(gnl_d)/, $(gnl_c))
gnl_h := $(INC_D)/ft_gnl.h
...
putters_h := $(INC_D)/ft_putters.h

stdbool_h := $(INC_D)/ft_stdbool.h

stdlib_d := $(SRC_D)/stdlib
stdlib_c := ft_atoi.c ft_calloc.c ft_itoa.c
stdlib_c := $(addprefix $(stdlib_d)/, $(stdlib_c))
stdlib_h := $(INC_D)/ft_stdlib.h
...
string_h := $(INC_D)/ft_string.h

# Files in total
HEADERS := $(ctype_h) $(gnl_h) $(slist_h) $(mem_h) $(putters_h) $(stdlib_h) $(string_h) $(stdbool_h)
SOURCES := $(ctype_c) $(gnl_c) $(slist_c) $(mem_c) $(putters_c) $(stdlib_c) $(string_c)
OBJECTS := $(SOURCES:.c=.o)
